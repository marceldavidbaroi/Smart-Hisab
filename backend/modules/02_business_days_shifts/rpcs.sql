-- ==============================================================================
-- MODULE 2: BUSINESS DAYS & SHIFTS (RPCS & FUNCTIONS)
-- Purpose: Business day open/close lifecycle, cash float tracking, expected
--          cash calculation, and closed-day data integrity locks.
-- ==============================================================================
...
-- 6. Trigger: Closed Day Data Lock Guard
