-- ==============================================================================
-- MODULE 6: STAFF & PAYROLL (RPCS & FUNCTIONS)
-- Purpose: Staff initialization, advance and monthly payroll disbursements from
--          canteen accounts, staff wallet balance sync, and staff PIN verification.
-- ==============================================================================
