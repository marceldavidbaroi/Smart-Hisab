-- ==============================================================================
-- MODULE 5: VENDORS & SUPPLIES / AP (RPCS & FUNCTIONS)
-- Purpose: Vendor creation trigger, vendor wallet sync, vendor settlement payments
--          from canteen accounts, and vendor chronological ledger statements.
-- ==============================================================================
