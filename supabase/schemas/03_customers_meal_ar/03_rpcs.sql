-- ==============================================================================
-- DOMAIN 03: CUSTOMERS & MEAL ATTENDANCE / AR — RPCS, FUNCTIONS & TRIGGERS
-- ==============================================================================
...
-- 2. Trigger Function: Sync customer wallet balance from entries
...
DROP TRIGGER IF EXISTS on_wallet_entry_changed ON public.wallet_entries;
CREATE TRIGGER on_wallet_entry_changed
...
DROP TRIGGER IF EXISTS on_customer_deactivate_guard ON public.customers;
CREATE TRIGGER on_customer_deactivate_guard
