-- ==============================================================================
-- DOMAIN 04: CASHBOOK & CANTEEN WALLETS — RPCS, FUNCTIONS & TRIGGERS
-- ==============================================================================
...
DROP TRIGGER IF EXISTS on_tenant_created_accounts ON public.tenants;
CREATE TRIGGER on_tenant_created_accounts
...
DROP TRIGGER IF EXISTS on_day_entry_changed_account_balance ON public.day_entries;
CREATE TRIGGER on_day_entry_changed_account_balance
