-- Migration: Fix Wallet Entries Staff ID and Voiding RPCs
-- Description: Adds missing recorded_by_staff_id and created_by_staff_id columns to wallet_entries,
--              vendor_wallet_entries, and day_entries, and recreates void_wallet_entry & void_day_entry RPCs.

-- 1. Ensure missing columns exist on ledger tables
...
-- 2. Indexes for metadata status lookups
...
-- 3. Recreate RPC: void_wallet_entry
