-- Migration: Atomic Customer Creation & Reactivation RPC
-- Description: Creates create_or_reactivate_customer RPC to atomically handle customer creation
--              and reactivation of previously inactive customer records.
...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO public.customers (
      tenant_id, name, phone, address, institution, is_active
    ) VALUES (
