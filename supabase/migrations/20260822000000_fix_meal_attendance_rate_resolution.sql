-- Migration: Fix Meal Attendance Rate Resolution
-- Description: Re-creates record_meal_attendance RPC to resolve meal charge rate dynamically
--              from shift-specific meal_configs first, falling back to tenant-level meal_configs.
