...
const keys = computed<KeyConfig[]>(() => [
  {
    value: '1',
    display: '1',
    label: t('kioskUI.pinpad.num', { num: 1 }),
    type: 'number',
    keyshortcut: '1',
  },
  {
    value: '2',
    display: '2',
    label: t('kioskUI.pinpad.num', { num: 2 }),
    type: 'number',
    keyshortcut: '2',
  },
  {
    value: '3',
    display: '3',
    label: t('kioskUI.pinpad.num', { num: 3 }),
    type: 'number',
    keyshortcut: '3',
  },
  {
    value: '4',
    display: '4',
    label: t('kioskUI.pinpad.num', { num: 4 }),
    type: 'number',
    keyshortcut: '4',
  },
  {
    value: '5',
    display: '5',
    label: t('kioskUI.pinpad.num', { num: 5 }),
    type: 'number',
    keyshortcut: '5',
  },
  {
    value: '6',
    display: '6',
    label: t('kioskUI.pinpad.num', { num: 6 }),
    type: 'number',
    keyshortcut: '6',
  },
  {
    value: '7',
    display: '7',
    label: t('kioskUI.pinpad.num', { num: 7 }),
    type: 'number',
    keyshortcut: '7',
  },
  {
    value: '8',
    display: '8',
    label: t('kioskUI.pinpad.num', { num: 8 }),
    type: 'number',
    keyshortcut: '8',
  },
  {
    value: '9',
    display: '9',
    label: t('kioskUI.pinpad.num', { num: 9 }),
    type: 'number',
    keyshortcut: '9',
  },
  {
  ...
  },
  {
    value: '0',
    display: '0',
    label: t('kioskUI.pinpad.num', { num: 0 }),
    type: 'number',
    keyshortcut: '0',
  },
  {
